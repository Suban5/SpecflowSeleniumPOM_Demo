...
using SpecFlowPSpecflowSeleniumPOM_Demo.Support;
using SpecflowSeleniumPOM_Demo.Config;
using SpecflowSeleniumPOM_Demo.Pages;
using SpecflowSeleniumPOM_Demo.Support;
using SpecFlSpecflowSeleniumPOM_DemowProject.Pages;
using System;
...
namespace SpecflowSeleniumPOM_Demo.StepDefinitions
{
    [Binding]
